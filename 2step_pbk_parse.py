...
def get_article_info(inp_id):
    ...
    true_title = true_title[0].text.strip()
    ...
    #print(text)
    #print(text[0].text)
    return (true_category, true_title, tmp_imgs, overview, len(text.split()), two_articles, ) #snd_header, snd_text
